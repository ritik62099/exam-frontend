...
//   const [durationHours, setDurationHours] = useState(24); // 🔹 NEW
//   const [showResults, setShowResults] = useState(true);   // 🔹 NEW
...
//           setShowResults(exam.showResults !== false); // default true
